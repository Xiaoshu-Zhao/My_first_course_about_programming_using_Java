public class Fraction implements Comparable<Fraction>
{
	...
	public int compareTo( Fraction other )
	{
		...
		Fraction subtractVar = new Fraction((numer * other.getDenom()) - (other.getNumer() * denom), denom * other.getDenom());
		...
		if (subtractVar.getNumer() > 0 && subtractVar.getDenom() > 0 || subtractVar.getNumer() < 0 && subtractVar.getDenom() < 0) return 1;
		if (subtractVar.getNumer() > 0 && subtractVar.getDenom() < 0 || subtractVar.getNumer() < 0 && subtractVar.getDenom() > 0 ) return -1;
